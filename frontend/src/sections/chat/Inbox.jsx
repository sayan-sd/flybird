...
const Inbox = () => {
    ...
    return (
        <>
                    ...
                    <div className="max-w-125">
                        ...
                        <div className="mb-2.5 rounded-2xl rounded-tl-none bg-gray px-5 py-3 dark:bg-boxdark-2">
                            <p>
                                ...
                                adipisicing elit. Mollitia fuga, distinctio
                                debitis consequatur sequi vero.
                            </p>
                        </div>
                    ...
                    <div className="max-w-125 ml-auto">
                        <div className="mb-2.5 rounded-2xl rounded-br-none bg-primary px-5 py-3">
                            <p className="text-white">
                                Lorem ipsum dolor sit amet, consectetur
                                adipisicing elit. Eveniet inventore impedit
                                architecto.
                            </p>
                        </div>
            ...
            {/* toggle user info on click of profile */}
            {userInfoOpen && (
                <div className="w-1/4">
